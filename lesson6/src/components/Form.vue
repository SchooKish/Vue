      ...
      <div class="modal" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDescription">
        <header class="modal-header" id="modalTitle">
          <slot name="header">
            ...
            <button type="button" class="btn-close" @click="closePaymentsForm" aria-label="Close modal">
              x
            </button>
          </slot>
        </header>
        ...
        <footer class="modal-footer">
          <slot name="footer">
            ...
            <button type="button" class="btn-green" @click="choosePaymentForm" aria-label="Close modal">
              Save and close
            </button>
          </slot>
        </footer>
...
export default {
  ...
  methods: {
    ...
    choosePaymentForm() {
      if (this.updatedId || this.updatedId === 0) {
    ...
    editPaymentForm() {
      ...
      this.editElemList(payload);
      this.date = "";
      this.category = "";
      this.price = "";
      // console.log({ date, category, price });
      this.$modal.close();
    },
